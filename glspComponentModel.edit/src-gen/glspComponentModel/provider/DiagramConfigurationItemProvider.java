...
/**
 * This is the item provider adapter for a {@link glspComponentModel.DiagramConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramConfigurationItemProvider extends LeafComponentItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DiagramConfiguration_type")
				: getString("_UI_DiagramConfiguration_type") + " " + label;
	}
